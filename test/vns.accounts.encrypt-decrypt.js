var Accounts = require("../packages/web3-vns-accounts/src/index.js");
...
describe("vns", function () {
    describe("accounts", function () {
        ...
        tests.forEach(function (test, i) {
            it("encrypt vns.account, and compare to ethers wallet", async () => {
            ...
            it("encrypt vns.account, and decrypt with ethers wallet", async () => {
                var ethAccounts = new Accounts();
            ...
            it("encrypt ethers wallet, and decrypt with vns.account", async () => {
                var ethAccounts = new Accounts();
            ...
            it("decrypt static signature using ethers wallet and vns.account and compare", async () => {
                var ethAccounts = new Accounts();
