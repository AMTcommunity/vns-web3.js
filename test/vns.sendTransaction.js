...
// using local wallet
    ...
    useLocalWallet: function (web3) {
        web3.vns.accounts.wallet.add('0xd7d364e720c129acb940439a84a99185dd55af6f6d105018a8acfb7f8c008142');
    },
    ...
    useLocalWallet: function (web3) {
        web3.vns.accounts.wallet.add('0xf7d364e720c129acb940439a84a99185dd55af6f6d105018a8acfb7f8c008142');
    },
    ...
    useLocalWallet: function (web3) {
        web3.vns.accounts.wallet.add('0xa1d364e720c129acb940439a84a99185dd55af6f6d105018a8acfb7f8c008142');
    },
...
describe(method, function () {
    tests.forEach(function (test, index) {
        it('promise test: ' + index, function (done) {
            ...
            provider.injectValidation(function (payload) {
                assert.equal(payload.method, 'vns_getTransactionReceipt');
            });
            ...
            if(test.error) {
                ...
                assert.throws(function(){ web3.vns[method].apply(web3, args); });
                done();
                ...
                result = web3.vns[method].apply(web3, args);
        ...
        it('callback test: ' + index, function (done) {
            ...
            if(test.error) {
                ...
                web3.vns[method].apply(web3, args);
            }
        });
    });
});
