...
describe('ens', function () {
    ...
    describe('in normal operation', function () {
        beforeEach(function () {
            ...
            provider.injectValidation(function (payload) {
                ...
                assert.equal(payload.method, 'vns_getBlockByNumber');
        ...
        it('should return the owner record for a name', function (done) {
            ...
            web3.vns.ens.registry.owner('foobar.eth').then(function (owner) {
        ...
        it('should fetch the resolver for a name', function (done) {
            ...
            web3.vns.ens.registry.resolver('foobar.eth').then(function (resolver) {
        ...
        it('should return the addr record for a name', function (done) {
            ...
            web3.vns.ens.getAddress('foobar.eth').then(function (addr) {
        ...
        it('should return x and y from an public key for en specific ens name', function (done) {
            ...
            web3.vns.ens.getPubkey('foobar.eth').then(function (result) {
        ...
        it('should get the content of an resolver', function (done) {
            ...
            web3.vns.ens.getContent('foobar.eth').then(function (result) {
    ...
    it("won't resolve on an unknown network", function (done) {
        ...
        web3.vns.ens.getAddress('foobar.eth').then(function () {
