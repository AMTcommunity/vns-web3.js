...
var Iban = require('../packages/web3-vns-iban');
...
var tests = [
    ...
    { obj: '{"c" : 2}', is: false},
    { obj: 'XE02VNSXREGGAVOFYORK', is: true},
    { obj: 'XE03VNSXREGGAVOFYORK', is: false}, // control number is invalid
    { obj: 'XE02ETCXREGGAVOFYORK', is: false},
    { obj: 'XE02VNSXREGGAVOFYORKD', is: false},
    { obj: 'XE02VNSXREGGaVOFYORK', is: false},
