...
var tests = [
    {
        ...
        // signature from vns_signTransaction
    ...
    },
    {
        ...
        // web3.vns.signTransaction({from: "0xEB014f8c8B418Db6b45774c326A0E64C78914dC0", gasPrice: "230000000000", gas: "50000", to: '0xFCAd0B19bB29D4674531d6f115237E16AfCE377c', value: "1000000000000000000", data: "0x0123abcd"}).then(console.log);
        // signature from vns_signTransaction
    ...
    describe("accounts", function () {
        ...
        tests.forEach(function (test, i) {
            if (test.error) {
                ...
                it("signTransaction must compare to vns_signTransaction", function(done) {
                    var ethAccounts = new Accounts();
                ...
                it("signTransaction using the iban as \"to\" must compare to vns_signTransaction", function(done) {
                    var ethAccounts = new Accounts();
                ...
                it("signTransaction will call for nonce", function(done) {
                    ...
                    provider.injectValidation(function (payload) {
                        ...
                        assert.equal(payload.method, 'vns_getTransactionCount');
                ...
                it("signTransaction will call for gasPrice", function(done) {
                    ...
                    provider.injectValidation(function (payload) {
                        assert.equal(payload.jsonrpc, '2.0');
                        assert.equal(payload.method, 'vns_gasPrice');
                ...
                it("signTransaction will call for chainId", function(done) {
                    ...
                    provider.injectValidation(function (payload) {
                        assert.equal(payload.jsonrpc, '2.0');
                        assert.equal(payload.method, 'vns_chainId');
                        assert.deepEqual(payload.params, []);
                    });
                ...
                it("signTransaction will call for networkId", function(done) {
                    ...
                    provider.injectValidation(function (payload) {
                        assert.equal(payload.jsonrpc, '2.0');
                        assert.equal(payload.method, 'vns_networkId');
                        assert.deepEqual(payload.params, []);
                    });
