...
var packages = [{
    ...
    fileName: 'web3-vns',
    expose: 'Web3Vns',
    src: './packages/web3-vns/src/index.js'
}, {
    fileName: 'web3-vns-accounts',
    expose: 'Web3VnsAccounts',
    src: './packages/web3-vns-accounts/src/index.js'
}, {
    fileName: 'web3-vns-contract',
    expose: 'Web3VnsContract',
    src: './packages/web3-vns-contract/src/index.js'
}, {
    fileName: 'web3-vns-personal',
    expose: 'Web3VNsPersonal',
    src: './packages/web3-vns-personal/src/index.js'
}, {
    fileName: 'web3-vns-iban',
    expose: 'Web3VnsIban',
    src: './packages/web3-vns-iban/src/index.js'
}, {
    fileName: 'web3-vns-abi',
    expose: 'Web3VnsAbi',
    src: './packages/web3-vns-abi/src/index.js'
},{
    fileName: 'web3-vns-ens',
    expose: 'VnsEns',
    src: './packages/web3-vns-ens/src/index.js'
},{
    fileName: 'web3-net',
    expose: 'Web3Net',
